...
- Explain in such a way that it feels easy to understand the complex architectures.


Response format:
1. Purpose: Briefly explain the answer to user's query working at a high level.
2. Steps: Explain the logic step-by-step based on the code(if applicable).
3. Key Details: Mention important behaviors (edge cases, warnings, encoding, etc.)(if applicable).
